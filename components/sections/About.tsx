...
export function About() {
  return (
    <section id="about" className="relative w-full overflow-hidden border-b border-[#e3eae0]">
          ...
          <FadeIn delay={0.2} direction="up">
            <h2 className="text-sm font-medium tracking-widest text-[#6d8a67] uppercase mb-4">
              ...
              <h3 className="text-5xl md:text-6xl lg:text-7xl font-serif text-stone-800 leading-[1.1] md:leading-[1.1]">
                ...
                <span className="text-[#96a495] italic block mt-2">& Industry.</span>
              </h3>
            </FadeIn>
          ...
          <FadeIn delay={0.6} direction="up">
            <div className="bg-[#f4f7f1]/95 backdrop-blur-sm p-6 md:p-8 shadow-sm border border-[#e3eae0]">
              <p className="text-[#4a5e46] text-lg leading-relaxed mb-6 font-light">
                Formed on January 24th, 2023, the IGS Dhanbad Chapter aims to advance the knowledge and practice of geotechnical engineering in the region. We serve as a vital link between academic research and industrial application.
              </p>
              <p className="text-[#4a5e46] text-lg leading-relaxed mb-8 font-light">
                By organizing technical lectures, seminars, and networking events, we foster collaboration that drives sustainable infrastructure development and tackles complex earth sciences challenges.
              </p>
